            ...
            <div className="row">
              <div className="col-6">
                ...
                <label>
                  ...
                  <img src={preview?preview:`${server_url}/uploads/${project?.projectImage}`} width={"100%"} alt="" />
                </label>
              ...
              <div className="col-6">
                ...
                <FloatingLabel controlId="floatinglanguage" label="Language-used">
                    <Form.Control type="text" placeholder="Enter your Project Language" value={projectData?.languages} onChange={e=>setProjectData({...projectData,languages:e.target.value})}/>
                </FloatingLabel>
                </div>
                ...
                <FloatingLabel controlId="floatingTitle" label="Website-Link">
                    <Form.Control type="text" placeholder="Enter your Project Title" value={projectData?.website} onChange={e=>setProjectData({...projectData,website:e.target.value})}/>
                </FloatingLabel>
                </div>
